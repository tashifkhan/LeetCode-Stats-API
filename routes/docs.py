...
PLATFORM = 'LeetCode'
ACCENT = '#ffa116'
DESCRIPTION = 'DSA profile analytics for solved counts, contest history, badges, submissions, and topic coverage.'
PARAM = 'username'
TRY_PATH = '/demo/profile'
SAMPLE = TRY_PATH.strip("/").split("/")[0]
PLATFORM_KEY = 'leetcode'
REPO = 'tashifkhan/LeetCodeStatsAPI'
...
CANONICAL_ENDPOINTS = [
    ...
    ('GET', '/{username}/stats', 'Solved counts and topic analysis'),
    ('GET', '/{username}/stats/svg', 'Embeddable stats SVG card (24h cache)'),
    ('GET', '/{username}/topics', 'Topic analysis'),
    ('GET', '/{username}/contests', 'Contest history'),
