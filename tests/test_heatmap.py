...
class HeatmapDecoderTests(unittest.TestCase):
    ...
    def test_decode_heatmap_builds_continuous_daily_series(self, mock_utc_today):
        ...
        response = ResponseDecoder.decode_heatmap(json_data)
